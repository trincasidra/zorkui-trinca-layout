...
local function OnEnter(self)
  ...
  --azerite
  local azeriteItem = cfg.showAzerite and C_AzeriteItem.FindActiveAzeriteItem()
  if azeriteItem then
  ...
  --islandweekly
  local iwqID = cfg.showIslandExpeditions and C_IslandsQueue.GetIslandsWeeklyQuestID()
  if iwqID and C_QuestLog.IsQuestFlaggedCompleted(iwqID) then
