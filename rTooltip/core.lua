...
cfg.pos = "ANCHOR_CURSOR" --"ANCHOR_NONE"
...
--SetBackdrop for all OnTooltip functions
GameTooltip:HookScript("OnTooltipSetUnit", SetBackdropStyle)
GameTooltip:HookScript("OnTooltipSetSpell", SetBackdropStyle)
GameTooltip:HookScript("OnTooltipSetItem", SetBackdropStyle)
GameTooltip:HookScript("OnTooltipSetAchievement", SetBackdropStyle)
