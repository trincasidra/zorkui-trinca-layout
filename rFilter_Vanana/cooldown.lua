...
if L.C.playerClass == "PRIEST" then
  ...
  -- shield
  rFilter:CreateCooldown(194509,36,{"TOPLEFT", oUF_SimplePlayer, "TOPRIGHT", 176, 0},"show",{1,1},true) --radiance
  rFilter:CreateCooldown(34433,24,{"TOPLEFT", oUF_SimplePlayer, "TOPRIGHT", 8, -42},"show",{1,1},true) --shadowling
  rFilter:CreateCooldown(32379,24,{"TOPLEFT", oUF_SimplePlayer, "TOPRIGHT", 38, -42},"show",{1,1},true) --death
  --
  --
  rFilter:CreateCooldown(8122,24,{"TOPLEFT", oUF_SimplePlayer, "TOPRIGHT", 158, -42},"show",{1,1},true) --fear
